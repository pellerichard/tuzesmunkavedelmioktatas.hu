        ...
        <template v-else>
            ...
            <v-container fluid grid-list-lg>
                ...
                <div class="text-sm-left">
                    <v-btn color="primary" class="white--text round-border" @click="$router.go(-1)">Vissza a bejegyzett cégekhez</v-btn>
                </div>
                        ...
                        <v-flex md4>
                            <v-card color="primary" class="white--text round-border">
                                <v-card-title primary-title>
                                    ...
                                    <span tabindex="-1" class="v-chip v-chip--select-multi v-chip--disabled theme--light combobox-permission">
                                        <span class="v-chip__content">{{ con.users.userPermission }}</span>
                                    </span>
                                    <!-- Csoportok -->
